...
int main(int argc, char* argv[])
{
	...
	//AVStream *st//need for writing

//<<<<<<< Updated upstream
//	//char filepath[]="bigbuckbunny_480x272.h265";
//	//char filepath_org[] = "F:\\Kai\\SQM\\HTTP\\DASH\\sample4\\exMPD_BIP_TC1.mpd";
//	char filepath_org[] = "C:\\Users\\liuxu\\Desktop\\New folder\\simplest_ffmpeg_player\\MultiRate.mpd";
//	//int video_id = 3;
//	//char filepath_org[] = "http://dash.edgesuite.net/dash264/TestCases/1a/netflix/exMPD_BIP_TC1.mpd";
//	MPD_parser* mpd_parser = new MPD_parser;
//	mpd_parser->master_link = "xxx";
//	//char* fname = new char[500];
//	std::string fname;
//	int ret1 = mpd_parser->mpdparser(filepath_org, &fname);
//
